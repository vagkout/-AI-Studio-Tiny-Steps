...
export const ItemDetailOverlay: React.FC<ItemDetailOverlayProps> = ({ item, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-white overflow-y-auto animate-in fade-in zoom-in-95 duration-300 ease-out">
      {/* Top Navigation Bar */}
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest bg-gray-50 px-2 py-1 rounded">
              {item.startAgeMonths}m Milestone
            </span>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 sm:py-20">
        <div className="space-y-16">
          ...
          <header className="text-center space-y-8">
            <div className="inline-flex w-24 h-24 bg-blue-50 rounded-3xl items-center justify-center text-5xl shadow-sm border border-blue-100">
              {item.icon}
            </div>
            ...
            <section className="space-y-6">
              ...
              <div className="prose prose-lg prose-gray max-w-none">
                <p className="text-gray-700 leading-relaxed text-lg sm:text-xl font-light">
                  {item.fullDescription || "Detailed guidance for this specific milestone is currently being curated by our specialists. Check back soon for deeper insights into your child's development."}
                </p>
              </div>
            </section>
